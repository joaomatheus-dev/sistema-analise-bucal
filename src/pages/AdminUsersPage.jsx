...
function AdminUsersPage({
  ...
  async function handleDelete(admin) {
    const confirmed = window.confirm(`Deseja realmente excluir o administrador "${admin.name}"?`);
    ...
    <section className="stack">
      <section className="hero-banner compact-hero">
        <div className="hero-banner-copy">
          ...
          <p>Crie novos acessos, atualize perfis e mantenha o controle da operação do sistema.</p>
        </div>
        <div className="metrics-pill">
          <span>{admins.length} administradores</span>
          <span>{currentUser?.name || "Sessão ativa"}</span>
        </div>
      </section>
      ...
      <section className="admin-layout">
        <article className="spotlight-card admin-side-card">
          ...
          <p>
            Cadastre responsáveis pela moderação do acervo, criação de categorias e gestão de
            casos.
          </p>
          <div className="admin-bullet-list">
            <span>Cadastro seguro</span>
            <span>Edição de perfil</span>
            <span>Bloqueio do usuário atual</span>
          </div>
        </article>
